...
export const IconTshirt: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 21v-3.75c0-1.02.83-1.85 1.85-1.85h10.8c1.02 0 1.85.83 1.85 1.85V21M6.75 12H17.25m-10.5 0L4.5 5.25m2.25 6.75L9 5.25m8.25 6.75L15 5.25M6.75 12l-1.125-1.125a1.875 1.875 0 0 0-2.65 0L2.25 11.625M17.25 12l1.125-1.125a1.875 1.875 0 0 1 2.65 0L21.75 11.625" />
    </svg>
);
...
export const IconArrowPath: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
